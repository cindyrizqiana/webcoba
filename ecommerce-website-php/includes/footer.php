<footer class="page-footer">
		...
		<div class="footer-nav__col footer-nav__col--info">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">sig in</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Campshop.<br>
				jln suryajayanegara desa bakung lor kec.jamblang kab.cirebon,Indonesia.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">082217874823</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">campshop@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2023 Campshop.&trade;
			</div>

			<div class="designby">
				Design by Cindy Rizqiana
			</div>
		</div>
	</div>
</footer>
